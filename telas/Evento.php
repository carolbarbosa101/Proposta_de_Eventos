  ...
  <div class="container">
    <div class="row mb-5">
      ...
      <div class="col-md-6 text-right">
        <button onclick="window.location='evento_form.php'" type="button" class="btn btn-primary" data-toggle="modal" data-target=".cadastrar-entidade-modal-lg">
            ...
            <tbody>
              ...
              <td>
                ...
                <a href="" class="btn btn-info mr-1">
                  ...
                  <a href="evento_editar.php" class="btn btn-warning mr-1">
                    Editar
                  </a>
